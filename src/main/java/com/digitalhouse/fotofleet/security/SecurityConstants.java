...
public class SecurityConstants {
    ...
    public static final String JWT_SIGNATURE = new String(Base64.getDecoder().decode("RmlybWEgc3VwZXIgbWVnYSB1bHRyYSByZWNvbnRyYSByZS1hcmNoaSBzZWNyZXRh".getBytes()), StandardCharsets.UTF_8);
}
